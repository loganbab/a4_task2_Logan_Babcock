...
ggplot(data = hare_weights, aes(x = weight, fill = full_sex)) + # exploratory histogram of weights with sex stacked
  ...
  labs(x = "Weight (g)", y = "Percent of sample", color = "Sex") + # adding labels
  theme_light() +
  theme(axis.text.x = element_text(size = 7, hjust = 0.5), # aesthetic adjustments
        axis.text.y = element_text(size = 7),
        axis.title.x = element_text(hjust = 0.5, 

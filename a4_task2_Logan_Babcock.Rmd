...
ggplot(data = yearly_count, aes(x = Year, y = Count)) + # makign a column chart to display counts
  ...
  scale_x_continuous(limits=c(1997,2013), breaks = c(1998, 2000, 2002, 2004, 2006, 2008, 2010, 2012)) + #setting the x ais labels

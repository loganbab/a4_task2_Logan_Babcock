...
```
In this section we compared the weights of juvenile showshoe hares based on sex using a unpaire t-test, a Cohen's test to see the effect size, and with summary statistics.

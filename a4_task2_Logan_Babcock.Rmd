...
With this linear regression, the R^2^ value of `r round(lm_hare_glance$r.squared,3)` means that only `r percentage(lm_hare_glance$r.squared,3)` of the variance is in body mass is predictable from the change in hindfoot length. 